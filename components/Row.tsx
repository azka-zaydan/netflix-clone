    ...
    return (
        <div className="h-40 space-y-0.5 md:space-y-2">
            ...
            <div className="group relative md:-ml-2">
                ...
                transition hover:scale-125 group-hover:opacity-100 ${!isMoved && "hidden"}`} onClick={() => handleClick('left')} />
                ...
                transition hover:scale-125 group-hover:opacity-100" onClick={() => handleClick('right')} />
            </div>
        </div>
    )
}
